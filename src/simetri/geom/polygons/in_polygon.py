...
from simetri.geom.points.point_utils import point_on_line_segment
from simetri.geom.points.point_utils import left
from simetri.geom.vectors import PointType, Sequence
...
def in_polygon(
    ...
    Examples:
        ::
            ...
            from simetri.geom.in_polygon import in_polygon
