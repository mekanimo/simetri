...
from simetri.core.all_enums import Connection
from simetri.core.common import PointType, get_defaults
from simetri.geometry.points.point_utils import close_points2, remove_bad_points
from simetri.geometry.segments.line_utils import (
    intersection,
    intersection3,
    sorted_edges,
)
from simetri.geometry.vectors import cross_product_sense, distance, sin
