...
from simetri.core.all_enums import Connection, Types
from simetri.core.common import LineType, PointType, get_defaults, i_vec, j_vec
from simetri.geometry.geometry import (
    positive_angle,
)
from simetri.geometry.geom_utils import connected_pairs
from simetri.geometry.geometry import area, bbox_overlap
from simetri.geometry.geom_utils import (
    close_points2,
    midpoint,
    offset_point_from_start,
)
from simetri.geometry.points.point_utils import (
    Vertex,
    between,
    clockwise,
    direction,
