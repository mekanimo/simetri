...
from simetri.core.all_enums import Types
from simetri.core.common import LineType, PointType, get_defaults
from simetri.geometry.affine import rotate_point
from simetri.geometry.geom_utils import (
    close_points2,
    distance2,
    midpoint,
    offset_point,
...
def fix_degen_points(
    ...
    if check_collinear:
        ...
        from simetri.geometry.segments.line_utils import (
...
def between(a, b, c):
    ...
    Examples:
        ...
        False
    """
    from simetri.geometry.segments.line_utils import collinear
...
def point_on_line(
    ...
    """
    from simetri.geometry.segments.line_utils import slope
...
def get_interior_points(start, end, n_points):
    ...
    """
    from simetri.geometry.segments.line_utils import line_angle
