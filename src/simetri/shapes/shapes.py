...
from ..geometry.nonlinear.ellipse import ellipse_points
from ..geometry.points.point_utils import distance
from ..geometry.geometry import (
    side_len_to_radius,
)
from ..geometry.points.point_utils import close_points2, midpoint
from ..geometry.polygons.polygon import offset_polygon_points
from ..geometry.segments.line_utils import angle_between_lines2, fillet_corners
from ..geometry.vectors import v_diff, v_scale, v_sum
from ..core.all_enums import Extent, Types
from ..group.batch import Group
from ..geometry.bbox import BoundingBox
from ..core.common import PointType, axis_x, get_defaults
from .shape import (
    Shape,
    custom_attributes,
)
from ..settings.settings import defaults
from ..geometry.affine import rotation_matrix
...
def rectangle_points(
    ...
    Examples:
        ...
        4
    """
    from ..geometry.affine import rotate
